...
describe("Cliente - Testes Unitários", () => {
  ...
  describe("Comportamentos da Entidade Cliente", () => {
    ...
    describe("Compras e Valores (Testes #9-10)", () => {
    ...
    describe("Pontos Iniciais e Bônus (Testes #13-15)", () => {
  ...
  describe("Repository e Service - Operações em Lista", () => {
    describe("Busca de Cliente (Testes #12, #21)", () => {
      let repository;
    ...
    describe("Operações em Lista (Testes #16-20, #22-23)", () => {
      let repository;
      let service;
      ...
      it("test #17: deve calcular pontos para lista de clientes", async () => {
        ...
        const resultado = calcularPontosLista(lista);
  ...
  describe("Validações e Regras de Negócio", () => {
    describe("Validações do ClienteRepository", () => {
      ...
      it("deve lançar erro ao tentar remover cliente null/undefined", () => {
        expect(() => repository.remover(null)).toThrow("Cliente inválido");
